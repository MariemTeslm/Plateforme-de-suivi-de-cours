...
if(empty($groupes)) die("Aucun groupe trouvé !");
...
// Récupérer l'id du groupe choisi
...
<head>
<meta charset="UTF-8">
<title>Emploi du temps du groupe</title>
...
<div class="form-box">
    <form method="get">
        <label for="id_groupe">Choisir un groupe :</label>
...
<?php if($id_groupe): ?>
<h2>Emploi du temps du groupe <?= htmlspecialchars($groupes[array_search($id_groupe,array_column($groupes,'id_groupe'))]['nom']) ?></h2>
<table>
    <tr>
        <th>Jour</th>
